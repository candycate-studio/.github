...
<img src="assets/logo.svg" alt="CandyCate Studio" width="440">
...
<sub>🐍 Агрегат коммит-активности по всем репозиториям студии за год · обновляется по расписанию. У организаций нет графа контрибуций, поэтому виджет собран под нас.</sub>

<!-- METRICS: карточка lowlighter/metrics (org-scope) появится здесь после установки секрета ORG_METRICS_TOKEN -->
...
<div align="center">
<sub>Продуктовые репозитории приватные — эта страница-витрина рассказывает о студии. © CandyCate Studio.</sub>
</div>
